...
<head>
  ...
  <!-- Favicons -->
  <link href="{{asset('assets/img/logoh.png')}}" rel="icon">
...
<body>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="container text-center text-md-left" data-aos="fade-up">
      ...
      <a href="{{url('form')}}" class="btn-get-started scrollto">PENDAFTARAN PPDB</a>
    </div>
  </section><!-- End Hero -->
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <img src="{{asset('assets/img/bg1.png')}}" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0">
            ...
            <div class="row icon-boxes">
              ...
              <div class="col-md-6 mt-4 mt-md-0">
               <img src="{{asset('assets/img/keunggulan.jpg')}}" width="270px" alt="">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row portfolio-container">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp">
            <div class="portfolio-wrap">
              <figure>
                <img src="{{asset('assets/img/pplg.jpg')}}" class="img-fluid" alt="">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp" data-wow-delay="0.2s">
            <div class="portfolio-wrap">
              <figure>
                <img src="{{asset('assets/img/dkv.jpg')}}" class="img-fluid" alt="">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card wow fadeInUp">
            <div class="portfolio-wrap">
              <figure>
                <img src="{{asset('assets/img/mplb.jpg')}}" class="img-fluid" alt="">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card wow fadeInUp" data-wow-delay="0.1s">
            <div class="portfolio-wrap">
              <figure>
                <img src="{{asset('assets/img/pmn.jpg')}}" class="img-fluid" alt="">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web wow fadeInUp" data-wow-delay="0.2s">
            <div class="portfolio-wrap">
              <figure>
                <img src="{{asset('assets/img/htl.jpg')}}" class="img-fluid" alt="">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web wow fadeInUp" data-wow-delay="0.1s">
            <div class="portfolio-wrap">
              <figure>
                <img src="{{asset('assets/img/tbg.JPG')}}" class="img-fluid" alt="">

			...
			<div class="container-fluid py-2">
				<div class="app-header-content">
					<div class="row justify-content-between align-items-center">
						...
						<div class="col mb-0">
							<p class="mb-0">Hi ! <?php echo e(Auth::user()->nama_lengkap); ?></p>
						</div>
						<!--//app-search-box-->
						...
						<div class="app-utilities col-auto">
							...
							<div class="app-utility-item app-user-dropdown dropdown">
								<a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#"
									role="button" aria-expanded="false"><img src="<?php echo e(asset('assets/img/profile.png')); ?>"
										alt="user profile"></a>
								<ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
									<li><a class="dropdown-item" href="<?php echo e(route('profile')); ?>">Account</a></li>
		...
		<div id="app-sidepanel" class="app-sidepanel">
			...
			<div class="sidepanel-inner d-flex flex-column">
				...
				<div class="app-branding">
					<a class="app-logo" href=""><img class="logo-icon me-2" src="<?php echo e(asset('assets/img/logoh.png')); ?>"
				...
				<nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
					<ul class="app-menu list-unstyled accordion" id="menu-accordion">
						...
						<li class="nav-item">
							...
							<a class="nav-link <?php echo e((request()->is('pembayaran')) ? 'active' : ''); ?>"
						...
						<li class="nav-item">
							<a class="nav-link <?php echo e((request()->is('pembayaran/admin')) ? 'active' : ''); ?>"
						...
						<li class="nav-item">
							<a class="nav-link <?php echo e((request()->is('/pemabayaran/all')) ? 'active' : ''); ?>"
								href="<?php echo e(route('pembayaran.all')); ?>">
								<span class="nav-icon">
									<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list"
										fill="currentColor" xmlns="http://www.w3.org/2000/svg">
										<path fill-rule="evenodd"
...
</html><?php /**PATH D:\Laravel Project\pklppdb\resources\views/components/layout-app.blade.php ENDPATH**/ ?>
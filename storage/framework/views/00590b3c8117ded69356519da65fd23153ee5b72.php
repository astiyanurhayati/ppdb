...
<body>
    <header class="d-flex justify-content-start align-items-center">
        <div class="logo">
            <img src="<?php echo e(asset('assets/img/logoh.png')); ?>" alt="" class="" width="120px">
        </div>
    ...
    <main>
        <div class="satu">
            ...
            <table cellspacing="0" cellpadding="4">
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td><?php echo e($item['no_phone']); ?></td>
                </tr>
                <tr>
                    <th width="50%">no hp ayah</th>
                    <td>:</td>
                    <td><?php echo e($item['no_phone_ayah']); ?></td>
                </tr>
                <tr>
                    <th width="50%">no hp ibu</th>
                    <td>:</td>
                    <td><?php echo e($item['no_phone_ibu']); ?></td>
                </tr>
        ...
        <div class="dua">
            ...
            <p>Password:<?php echo e($item['nisn']); ?></p>
...
</html><?php /**PATH D:\Laravel Project\pklppdb\resources\views/form/output.blade.php ENDPATH**/ ?>
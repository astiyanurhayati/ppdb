	    ...
	    <div class="col-12 col-md-7 col-lg-6 auth-main-col text-center p-5">
		    <div class="d-flex flex-column align-content-end">
				<div class="app-auth-body mx-auto">	
					<div class="app-auth-branding mb-4"><a class="app-logo" href="index.html"><img class="logo-icon me-2" src="<?php echo e(asset('assets/img/logoh.png')); ?>" alt="logo"></a></div>
					<h2 class="auth-heading text-center mb-5">Log in</h2>
					<?php if(Session::get('notAllowed')): ?>
					<div class="alert alert-danger">
						<?php echo e(session('notAllowed')); ?>
			        ...
			        <div class="auth-form-container text-start">
						<form class="auth-form login-form" action="<?php echo e(route('login.auth')); ?>" method="POST">       
							<?php echo csrf_field(); ?>  
						...
						<div class="auth-option text-center pt-5">Belum Punya Akun? <a class="text-link" href="<?php echo e(url('/form')); ?>" >Register Terlebih dahulu</a>.</div>
					</div>	
...
<?php /**PATH D:\Laravel Project\pklppdb\resources\views/login/login.blade.php ENDPATH**/ ?>